    ...
    <main>
      ...
      <div className="flex flex-col md:flex-row gap-4">
        ...
        <div className="w-full md:w-1/2 grid grid-cols-1 md:grid-cols-2 gap-2">
          ...
          <StatCard className="gap-2" title="Total Revenue" value={156234} icon={DollarSign} format="currency" trend={12} />
          <StatCard className="gap-2" title="Total Orders" value={1243} icon={ShoppingCart} format="number" trend={8} />
          <StatCard className="gap-2" title="Total Products" value={582} icon={Package} format="number" trend={-2} />
          <StatCard className="gap-2" title="Growth" value={23.5} icon={TrendingUp} format="percent" trend={5} />
      ...
      <div className="flex flex-col md:flex-row gap-4 mt-4">
        ...
        <CardContent className="p-0 max-w-full overflow-x-auto">
          <table className="w-full whitespace-nowrap border-collapse m-0 p-0">
            <thead>

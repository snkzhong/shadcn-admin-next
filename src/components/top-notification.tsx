    ...
    return (
        <Popover>
            ...
            <PopoverContent
                side="bottom"
                align="end"
                className="w-full md:w-80 max-h-[80vh] p-0 flex flex-col"
            >
                {/* 顶部标题 + 总数 */}
                ...
                {/* 消息列表 */}
                <div className="px-4 max-h-[50vh] overflow-auto scrollbar-thin">
                        ...
                        {data.map((item) => {
                            ...
                            return (
                                ...
                                >
                                    {/* icon */}
                                    <div
                                        className={`shrink-0 flex h-10 w-10 items-center justify-center rounded-lg ${color}`}
                                    >

...
export default function TopAppDock() {
    ...
    return (
        <DropdownMenu open={open} onOpenChange={setOpen}>
            ...
            <DropdownMenuContent
                className="max-h-[90vh] w-full md:w-120 p-4 scrollbar-thin"
                align="end"
            >
                    ...
                    {apps.map((app, idx) => {
                        ...
                        return (
                            <div
                                ...
                                className={cn(
                                    "flex flex-col items-center justify-center space-y-2 hover:bg-accent rounded-lg p-2 cursor-pointer",
                                )}
                            >
                                <Icon
                                    className={cn("w-8 h-8 rounded", color)}
                                />
